...
def process_in_param(driver: Driver, param_id: str, component_id: str, is_workflow: bool, type: str = None):
    """
    ...
    Returns:
        None
    """
    param_node = ensure_in_parameter_node(driver, param_id, component_id, type)
    if not is_workflow:
